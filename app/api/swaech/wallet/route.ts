...
export async function POST(req: Request) {
  ...
  // ⚠️  SECURITY: Only allow debit transactions from client. Credits must be admin-initiated via internal APIs.
  if (type !== "debit")
    return NextResponse.json({ error: "Only debit transactions are allowed via this endpoint" }, { status: 403 });
