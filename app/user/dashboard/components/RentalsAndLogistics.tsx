  ...
  return (
    <div className="mt-4">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {rentals.map((r) => (
            <div key={r.id} className="card-base rounded-2xl p-5">
          ...
          <form onSubmit={handleSubmit} className="bg-white dark:bg-[#18122b] rounded-2xl shadow-2xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea name="rules" className={`${inputCls} min-h-20 resize-y`} value={form.rules} onChange={handleChange} placeholder="One rule per line" />
              </div>
            </div>
    ...
    <div className="mt-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        {SERVICE_TYPES.map((type) => {
          ...
          return (
            <div key={type} className="flex flex-col items-center card-base rounded-2xl py-5 px-2">
              {SERVICE_ICONS[type]}
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {services.map((s) => (
            <div key={s.id} className="card-base rounded-2xl p-5">
          ...
          <form onSubmit={handleSubmit} className="bg-white dark:bg-[#18122b] rounded-2xl shadow-2xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea name="description" className={`${inputCls} min-h-20 resize-none`} value={form.description} onChange={handleChange} />
              </div>
              <div className="sm:col-span-2">
                <label className="text-xs text-gray-500 dark:text-[#8b949e] mb-1 block">Coverage Areas</label>
                <textarea name="coverage" className={`${inputCls} min-h-15 resize-y`} value={form.coverage} onChange={handleChange} placeholder="One area per line" />
              </div>
              <div>
